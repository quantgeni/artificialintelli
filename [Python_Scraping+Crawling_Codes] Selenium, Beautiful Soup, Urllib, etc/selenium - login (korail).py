...
try:
    ...
    bgnst.clear();bgnst.send_keys('부산')
    time.sleep(1)
    endst.clear();endst.send_keys('서울')
    time.sleep(1)
    ...
    time.sleep(1)
    chrome.find_element_by_xpath('//*[@id="s_month"]/option[text()="12"]').click()
    time.sleep(1)
    chrome.find_element_by_xpath('//*[@id="s_day"]/option[text()="5"]').click()
    time.sleep(1)
